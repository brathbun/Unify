<div id="container" class="large-12 columns">
	...
	<div data-alert class="large-5 large-centered columns alert-box warning round">
	...
	<form data-abide action="registerUser" method="post" accept-charset="utf-8">
		...
		<div class="large-5 large-centered columns">
			<div class="row collapse">
				...
				<div class="large-8 large-centered columns">
					<input type="password" required name="password" pattern="[a-zA-Z0-9]+" placeholder="...security FTW!" maxlength="80">
		...
		<div class="large-5 large-centered columns">
			<div class="row collapse">
				...
				<div class="large-8 large-centered columns">
					<input type="password" required pattern="password" data-equalto="password" placeholder="...one more time champ!" maxlength="80">
